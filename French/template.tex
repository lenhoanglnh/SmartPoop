...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\Huge $title$}\\[20pt]
	% {\Large Make articifial intelligence \\ robustly beneficial \\[20pt]}
	...
	{\scshape\Large $for(author)$$author$$sep$ \vspace{0.3\baselineskip} et \vspace{0.3\baselineskip} $endfor$} % Editor list
